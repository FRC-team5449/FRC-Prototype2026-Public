...
public class Intake extends SubsystemBase {
    ...
    private static final LoggedTunableNumber armIntakePos = new LoggedTunableNumber("Intake/Intake/LArmPos", 19);
    ...
    private static final LoggedTunableNumber rollerOuttakeVolts = new LoggedTunableNumber("Intake/Outtake/RollerVolts", -12.0);
    private static final LoggedTunableNumber rollerStopVolts = new LoggedTunableNumber("Intake/Stop/RollerVolts", 0);
    private static final LoggedTunableNumber RarmIntakePos = new LoggedTunableNumber("Intake/Intake/RArmPos", -19);
